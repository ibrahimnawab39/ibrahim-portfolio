...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $experiences = [
            ['role' => 'Back End Developer', 'company' => 'Siin | سين', 'company_url' => null, 'employment_type' => 'Full-time', 'work_mode' => 'Remote', 'location' => 'Karachi, Sindh, Pakistan', 'start_date' => '2024-12-01', 'end_date' => null, 'description' => 'Backend development for the Siin product ecosystem, including Siin mobile applications, Siin Admin and Seller Hub.'],
            ['role' => 'Full-stack Developer', 'company' => 'K-Labs', 'company_url' => 'https://klabs.co', 'employment_type' => 'Full-time', 'work_mode' => 'On-site', 'location' => 'Karachi, Sindh, Pakistan', 'start_date' => '2023-07-01', 'end_date' => null, 'description' => 'Laravel, WordPress, Flutter and platform work including Visit Bahrain, Baity (Eskan Bank), Bahrain Basketball Association and King Hamad Global Center for Peaceful Coexistence.'],
            ['role' => 'Full Stack Developer', 'company' => 'Freelancer.com', 'company_url' => 'https://www.freelancer.com', 'employment_type' => 'Freelance', 'work_mode' => 'Remote', 'location' => 'Pakistan', 'start_date' => '2019-12-01', 'end_date' => null, 'description' => 'Freelance full-stack delivery including Airport Pickups, Expert Community and UK Education Center.'],
            ['role' => 'Full-Stack Developer', 'company' => 'Fiverr', 'company_url' => 'https://www.fiverr.com', 'employment_type' => 'Freelance', 'work_mode' => 'Remote', 'location' => 'Pakistan', 'start_date' => '2022-02-01', 'end_date' => null, 'description' => 'Freelance web development including Airport Pickups and Clarice, using SQL and JavaScript frameworks.'],
            ['role' => 'Sr Laravel Developer', 'company' => 'DotClick', 'company_url' => null, 'employment_type' => 'Part-time', 'work_mode' => 'Remote', 'location' => 'Karachi Division, Sindh, Pakistan', 'start_date' => '2023-03-01', 'end_date' => '2023-10-31', 'description' => 'Senior Laravel development in a remote part-time role with SQL and JavaScript framework work.'],
            ['role' => 'Full-stack Developer', 'company' => 'webbulls.us', 'company_url' => 'https://www.webbulls.us', 'employment_type' => 'Full-time', 'work_mode' => 'On-site', 'location' => 'Karachi, Sindh, Pakistan', 'start_date' => '2022-10-01', 'end_date' => '2023-06-30', 'description' => 'Laravel and SQL development across projects including Screen Boogers, SS247 and ReaxRealty.'],
            ['role' => 'Full Stack Developer', 'company' => 'Digitach (Pvt.) Ltd', 'company_url' => null, 'employment_type' => 'Full-time', 'work_mode' => 'On-site', 'location' => 'Karachi, Sindh, Pakistan', 'start_date' => '2022-09-01', 'end_date' => '2022-10-31', 'description' => 'Laravel and WordPress delivery including Logo Prime and the company services website.'],
            ['role' => 'Senior PHP Developer', 'company' => 'Xiom Software Company', 'company_url' => null, 'employment_type' => 'Full-time', 'work_mode' => 'On-site', 'location' => 'Karachi, Sindh, Pakistan', 'start_date' => '2021-07-01', 'end_date' => '2022-09-30', 'description' => 'Senior PHP development across Sirviktor, My STU, Skincardz and other Laravel and C# projects.'],
            ['role' => 'PHP Developer', 'company' => 'Deevloopers', 'company_url' => 'https://deevloopers.com', 'employment_type' => 'Full-time', 'work_mode' => 'On-site', 'location' => 'Karachi, Sindh, Pakistan', 'start_date' => '2020-07-01', 'end_date' => '2021-07-31', 'description' => 'PHP and Laravel development for customer projects and the Deevloopers company platform.'],
        ];
        ...
        $projects = [
            ...
            ['Airport Pickups', 'airport-pickups', 'WordPress website', 'Freelancer.com', 'WordPress site for Toronto Pearson Airport taxi and limo bookings — flat-rate calculator, fleet pages and GTA service coverage.', 'Airport Pickups is a live WordPress experience for Pearson Airport (YYZ) taxi and limousine transfers across the GTA. Work covered WordPress design and implementation for booking-oriented pages, service areas, fleet presentation and conversion-focused content.', ['WordPress Design', 'WordPress', 'Elementor'], true, null, null],
            ['PRENCO', 'prenco', 'Company website', 'Pristine Engineering Corporation', 'Corporate website for Pristine Engineering Corporation — structural engineering, architecture and consultancy presence for Karachi and Pakistan.', 'PRENCO is a structural engineering and architectural consultancy site covering residential, commercial and industrial services across Karachi and Pakistan.', ['WordPress', 'Web Development', 'HTML5', 'CSS'], true, null, null],
            ...
            ['Faz3a Client', 'faz3a-client', 'Flutter application', 'K-Labs', 'Faz3a client app on Google Play — home and roadside services in Bahrain, real-time provider matching and live job tracking.', 'Faz3a (فزعة) connects Bahraini users with qualified home and roadside service professionals. Flutter client app published on Google Play; delivered with K-Labs.', ['Flutter', 'Dart', 'Mobile', 'API'], true, null, null],
            ...
            ['Baity', 'baity', 'Flutter application', 'K-Labs', 'Eskan Bank’s digital property advisor for Bahrain — contributed selected product and engineering support on the mobile experience through K-Labs.', 'Baity (بيتي) is Eskan Bank’s digital property advisor with 10,000+ listings, Baity 360 virtual tours, financing tools and project discovery. Delivered with K-Labs for Eskan Bank; involvement covered selected mobile and product engineering contributions rather than full ownership of the app.', ['Flutter', 'Mobile', 'API'], true, null, null],
        ...
        $this->call(PortfolioAssetsSeeder::class);
    }
}
