    ...
    <GuestLayout>
        ...
        <form class="auth-form" @submit.prevent="submit">
            <label>
                ...
                <input v-model="form.email" type="email" required autofocus autocomplete="username" placeholder="you@example.com">
                <small v-if="form.errors.email">{{ form.errors.email }}</small>
            </label>
            <label>
                <span>Password</span>
                <input v-model="form.password" type="password" required autocomplete="current-password" placeholder="Your password">
            ...
            <button type="submit" :disabled="form.processing">
                <span>{{ form.processing ? 'Signing in…' : 'Sign in to CMS' }}</span>
                <b>↗</b>
            </button>
        </form>
    </GuestLayout>
